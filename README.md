...
* Utilized Trello to manage workflow, practiced agile development, and communicated via Teams and Discord.
...
### Repurposed AIOs with Puppy OS for Nearby Elderly Center! (WIP) (Progress Photos)
* Booting Puppy OS onto a handful of Gateway and HP AIOs no longer used by an IT company.
* Goal: Repurpose for elderly ease of use, and repurpose old hardware, avoiding e-waste!
* Bonus: Attempt to configure locally accessible photo storage for those who have run out of storage.

### Repurposed Water-Damaged M1 MacBook Pro 2019! (WIP) (Progress Photos)
* Water/juice damaged MacBook, unusable LCD and corrosion around USB-C ports.
* Goal: Detach LCD, test logic board components, and repurpose with external monitor as a Mac homelab.
* Bonus: Replace LCD in the future or attach Mac to desktop as-is.

## SKILLS
-----------------------------------------------------------------------------------------------
### Core Competencies &amp; Values
* Fast self-learner, willing to learn, leadership capable, adaptable, agile methodologies.
...
## WORK EXPERIENCE
-----------------------------------------------------------------------------------------------
### T-Mobile, Mobile Expert || October 2024 – January 2026
* Leveraged Power BI to view personal metrics for areas of improvement, data reporting, and aggregation.
* Resolved daily technical issues to ensure smooth operation and customer satisfaction.
...
* Stocked produce, operated machinery, adjusted stock orders, and maintained inventory accuracy.
...
* Utilized company standard applications to assist customers, allocate stock, and complete work-related tasks.
...
* Performed and attended belt tests for students and planned ceremonial presentations and lesson scheduling.
